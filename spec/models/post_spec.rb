...
RSpec.describe Post, type: :model do
  ...
  describe ".post_ad_title_presence" do
    context "when ad title present" do
      it "post having a title is valid" do
        expect(subject).to be_valid
      end
    end
    context "when ad title not present" do
  ...
  describe ".post_ad_title_length" do
    context "with valid ad title length" do
      it "post having title of length within 2 and 14 characters is valid" do
        expect(subject).to be_valid
      end
    end
    context "with invalid ad title length" do
  ...
  describe ".post_ad_title_format" do
    context "with valid ad title format" do
    ...
    context "with invalid ad title format" do
  ...
  describe ".post_detailed_ad_title_presence" do
    context "when detailed ad title present" do
      it "post having a detailed title is valid" do
        expect(subject).to be_valid
      end
    end
    context "when detailed ad title not present" do
  ...
  describe ".post_detailed_ad_title_length" do
    context "with valid detailed ad title length" do
      it "post having detailed title of length within 2 and 30 characters is valid" do
        expect(subject).to be_valid
      end
    end
    context "with invalid detailed ad title length" do
  ...
  describe ".post_detailed_ad_title_format" do
    context "with valid detailed ad title format" do
    ...
    context "with invalid detailed ad title format" do
  ...
  describe ".post_ad_description_presence" do
    context "when ad description present" do
      it "post having an ad description is valid" do
        expect(subject).to be_valid
      end
    end
    context "when ad description not present" do
  ...
  describe ".post_ad_description_length" do
    context "with valid ad description length" do
      it "post having ad description of length within 2 and 255 characters is valid" do
        expect(subject).to be_valid
      end
    end
    context "with invalid ad description length" do
  ...
  describe ".post_contact_number_presence" do
    context "when contact number present" do
      it "post having a contact number is valid" do
        expect(subject).to be_valid
      end
    end
    context "when contact number not present" do
  ...
  describe ".post_contact_number_length" do
    context "with valid contact number length" do
      it "post having contact number of length within 10 and 15 characters is valid" do
        expect(subject).to be_valid
      end
    end
    context "with invalid contact number length" do
  ...
  describe ".post_contact_number_format" do
    context "with valid contact number format" do
    ...
    context "with invalid contact number format" do
  ...
  describe ".post_city_name_presence" do
    context "when city name present" do
      it "post having a city name is valid" do
        expect(subject).to be_valid
      end
    end
    context "when city name not present" do
  ...
  describe ".post_city_name_length" do
    context "with valid city name length" do
      it "post having city name of length within 1 and 14 characters is valid" do
        expect(subject).to be_valid
      end
    end
    context "with invalid city name length" do
